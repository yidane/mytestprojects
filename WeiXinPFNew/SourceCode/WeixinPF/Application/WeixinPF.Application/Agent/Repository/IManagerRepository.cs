...
namespace WeixinPF.Application.Agent.Repository
{
    public interface IManagerRepository //: IRepository<ManagerInfo>
    {
        ...
        /// 查询用户名是否存在
        /// </summary>
        bool Exists(string user_name, string email);
        ...
        /// 根据用户名密码返回一个实体
        /// </summary>
        ManagerInfo GetModel(string user_name, string password);

        /// <summary>
        /// 根据用户名密码返回一个实体
        /// </summary>
        ManagerInfo GetModel(string user_name, string password, bool is_encrypt);
